...
namespace FIMSpace.Generating
{
    ...
    public class RectangleOfFieldsGenerator : PGGGeneratorBase
    {
        ...
        public override void GenerateObjects()
        {
            ...
            Generated = new List<FieldGenerationInfo>();
            ...
            if (UseCorridorGuide)
            {
                ...
                {
                    FieldGenerationInfo g = IGeneration.GenerateFieldObjectsWithContainer(CorridorPreset.name, CorridorPreset, corridorGrid.grid, transform, corridorGrid.guides, corridorGrid.inject);
                    Generated.Add(g);
                }
            }
            ...
            for (int i = 0; i < staticRoomGrids.Count; i++)
            {
                ...
                FieldGenerationInfo g = IGeneration.GenerateFieldObjectsWithContainer(targetFieldSetup.name, targetFieldSetup, staticRoomGrids[i].grid, transform, staticRoomGrids[i].guides, staticRoomGrids[i].inject);
                Generated.Add(g);
            }
            ...
            for (int i = 0; i < roomsGrids.Count; i++)
            {
                ...
                FieldGenerationInfo g = IGeneration.GenerateFieldObjectsWithContainer(targetFieldSetup.name, targetFieldSetup, roomsGrids[i].grid, transform, roomsGrids[i].guides, roomsGrids[i].inject);
                Generated.Add(g);
            }
