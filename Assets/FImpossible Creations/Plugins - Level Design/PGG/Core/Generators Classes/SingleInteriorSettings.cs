...
namespace FIMSpace.Generating.Planning
{
    ...
    public class SingleInteriorSettings
    {
        ...
        public FieldGenerationInfo GenerateOnGrid(FGenGraph<FieldCell, FGenPoint> grid, List<SpawnInstruction> guides, Transform parent, Vector3 offset)
        {
            if (FieldSetup == null)
            {
        ...
        public FieldGenerationInfo GenerateOnGrid(GridPlanGeneratingHelper helper, Transform parent)
        {
