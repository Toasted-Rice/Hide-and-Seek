...
namespace FIMSpace.Generating
{
    public abstract class PGGGeneratorBase : MonoBehaviour
    {
        ...
        [HideInInspector] public List<FieldGenerationInfo> Generated = new List<FieldGenerationInfo>();
        ...
        public T GetComponentFromAllGenerated<T>() where T : Component
        {
            ...
            {
                FieldGenerationInfo tgtInfo = Generated[g];
        ...
        {
            FieldGenerationInfo tgtInfo = null;
