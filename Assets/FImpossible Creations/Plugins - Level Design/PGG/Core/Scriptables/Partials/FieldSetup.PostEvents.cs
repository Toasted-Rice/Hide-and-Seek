...
namespace FIMSpace.Generating
{
    public partial class FieldSetup : ScriptableObject
    {
        ...
        /// </summary>
        public void PostEvents(ref FieldGenerationInfo generatedRef, FGenGraph<FieldCell, FGenPoint> grid, Bounds fieldBounds, Transform container)
        {
        ...
        void GenerateLightProbes(FGenGraph<FieldCell, FGenPoint> grid, ref FieldGenerationInfo generatedRef, Bounds fieldBounds, Transform container)
        {
#if UNITY_EDITOR
        ...
        void CheckGraphForNearestMargins(FGenGraph<FieldCell, FGenPoint> grid, int maxCells, FieldCell root, ref FieldCell px, ref FieldCell nx, ref FieldCell pz, ref FieldCell nz)
        {
