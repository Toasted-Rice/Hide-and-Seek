...
namespace FIMSpace.Generating
{
    ...
    public abstract partial class SpawnRuleBase : ScriptableObject
    {
        ...
        internal bool _editor_drawRule = true;
        ...
        /// <summary> Executed every time when starting sequence of checking all cells with rules </summary>
        ...
        /// <summary> Executed only once when occupied cell is known after running all rule checks </summary>
        public virtual void CellInfluence(FieldSetup preset, FieldModification mod, FieldCell cell, ref SpawnData spawn, FGenGraph<FieldCell, FGenPoint> grid)
        { }

        /// <summary> Executed at the end of rules if all conditions met, only when implements ISpawnProcedureType with EProcedureType.OnConditionsMet type or Coded type </summary>
        ...
        /// </summary>
        public EGRuleResult RunSpawnMod(FieldSetup preset, FieldModification mod, FieldCell cell, ref SpawnData spawn, FGenGraph<FieldCell, FGenPoint> grid)
        {
            ...
            if (complete)
            {
                CellInfluence(preset, mod, cell, ref spawn, grid);
        ...
        /// <summary> Useful for custom coded rules</summary>
        protected void AddTempData(SpawnData data)
        {
