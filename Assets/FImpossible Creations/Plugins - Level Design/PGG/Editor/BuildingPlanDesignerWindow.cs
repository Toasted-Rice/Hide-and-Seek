...
namespace FIMSpace.Generating
{
    public partial class BuildingPlanDesignerWindow : EditorWindow
    {
        ...
        [MenuItem("Window/FImpossible Creations/Level Design/Build Plan Designer", false, 51)]
        static void Init()
        {
            BuildingPlanDesignerWindow window = (BuildingPlanDesignerWindow)GetWindow(typeof(BuildingPlanDesignerWindow));
            window.titleContent = new GUIContent("Build Plan", Resources.Load<Texture>("SPR_IGSmall"));
            window.Show();
        ...
        void OnGUI()
        {
            ...
            if (foldout)
                BuildPlanPresetEditor.DrawSettings(selectedPreset, select, true, true);
