    ...
    public class ModificatorsPackEditor : Editor
    {
        ...
        public static void RemoveModFrom(ModificatorsPack pack, FieldModification toRemove, bool delete)
        {
            try
            {
                ...
                pack.FieldModificators.Remove(toRemove);
#if UNITY_2018_4_OR_NEWER
        ...
        /// </summary>
        public static void DrawFieldModList(ModificatorsPack toDraw, string title, ref bool foldout, UnityEngine.Object toDirty = null, bool drawLock = false, FieldSetup useOnField = null)
        {
            ...
            string fold = foldout ? " ▼" : " ►";
            if (GUILayout.Button(fold + "  " + title + " (" + toDraw.FieldModificators.Count + ")", EditorStyles.label, GUILayout.Width(190))) foldout = !foldout;
        ...
        private static void DuplicateModificator(FieldSetup root, FieldModification mod)
        {
            FieldModification newR;
        ...
        public static void DrawRenameScriptableButton(ScriptableObject mod)
        {
            if (GUILayout.Button(new GUIContent(FGUI_Resources.Tex_Rename, "Rename modificator name (Save-File popup window will not create file, it will just take written name)"), new GUILayoutOption[2] { GUILayout.Width(32), GUILayout.Height(20) }))
            {
                string filename = EditorUtility.SaveFilePanelInProject("Type your title (no file will be created)", mod.name, "", "Type your title (no file will be created)");
        ...
        public static List<FieldVariable> TryGetFieldVariablesList(ModificatorsPack pack)
        {
