        ...
        public override void CheckRuleOn(FieldModification mod, ref SpawnData spawn, FieldSetup preset, FieldCell cell, FGenGraph<FieldCell, FGenPoint> grid, Vector3? restrictDirection = null)
        {
            ...
            else
            {
                ...
                if (RunOnRepetition == false)
                {
                    ...
                    {
                        spawn.TempRotationOffset = gettedSpwn.RotationOffset + RotationEulerOffset;
                        spawn.TempPositionOffset = gettedSpwn.Offset + Quaternion.Euler(gettedSpwn.RotationOffset) * gettedSpwn.DirectionalOffset;
                ...
                else
                {
                    ...
                    for (int a = 0; a < allSpawns.Count; a++)
                    {
                        ...
                        if (SpawnHaveSpecifics(aSpawn, GetFromTagged, CheckMode))
                        {
                            ...
                            aSpawn.TempRotationOffset = aSpawn.RotationOffset + RotationEulerOffset;
                            aSpawn.TempPositionOffset = aSpawn.Offset + Quaternion.Euler(aSpawn.RotationOffset) * aSpawn.DirectionalOffset;
        ...
        public override void CellInfluence(FieldSetup preset, FieldModification mod, FieldCell cell, ref SpawnData spawn, FGenGraph<FieldCell, FGenPoint> grid)
        {
            ...
            for (int i = 0; i < getted.Count; i++)
            {
                ...
                if (getSpawn != null)
                {
                    ...
                    Vector3 getDirOff = getSpawn.DirectionalOffset;
                    ...
                    thisSpawn.RotationOffset = getSpawn.RotationOffset + RotationEulerOffset;
